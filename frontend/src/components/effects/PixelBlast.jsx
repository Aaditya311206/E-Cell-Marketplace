...
void main(){
  ...
  float coverage = bw * jitterScale; float M;
...
export default function PixelBlast({
  ...
  useEffect(() => {
    ...
    if (!threeRef.current) {
      ...
      threeRef.current = { renderer, scene, camera, material, quad, ro, raf: 0, clickIx: 0, uniforms };
  ...
  }, [pixelSize, variant, color, patternScale, patternDensity]);

  return (
    <div ref={containerRef} className={`absolute inset-0 -z-10 ${className ?? ''}`} style={style} />
  );
}
