...
export default function Login() {
  ...
  return (
    ...
    >
      <div className="glass-card static-card w-full max-w-md p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 font-medium">Log in to your campus network.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            {loading ? "Logging in..." : "Access Marketplace"}
          </button>

          <div className="relative flex items-center py-4">
            <div className="flex-grow border-t border-slate-700" />
            <span className="flex-shrink-0 mx-4 text-slate-500 text-sm font-bold">OR</span>
            <div className="flex-grow border-t border-slate-700" />
          </div>
          ...
          <button
            type="button"
            disabled
            className="w-full bg-slate-800 border border-slate-600 text-slate-500 font-bold py-3.5 rounded-xl flex items-center justify-center gap-3 cursor-not-allowed"
          >
